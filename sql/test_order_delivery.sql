...
CREATE TABLE test_order_delivery (
    ...
    replace_character1 VARCHAR(200) NULL COMMENT '대치문자 1',
    replace_character2 VARCHAR(200) NULL COMMENT '대치문자 2',
    replace_character3 VARCHAR(200) NULL COMMENT '대치문자 3',

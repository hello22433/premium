...
| daou_orphan_pins_3161 | order_delivery_id | int | NO | PRI | NULL | |
| daou_orphan_pins_3161 | db_pin | varchar(64) | NO | | NULL | |
| daou_orphan_pins_3161 | orphan_pin | varchar(64) | NO | | NULL | |
| daou_orphan_pins_3161 | orphan_ts_id | varchar(64) | YES | | NULL | |
| daou_orphan_pins_3161 | history_id | int | NO | | NULL | |
| daou_orphan_pins_3161 | cancel_status | varchar(32) | YES | | PENDING | |
| daou_orphan_pins_3161 | cancel_attempted_at | datetime | YES | | NULL | |
| daou_orphan_pins_3161 | cancel_response | text | YES | | NULL | |
| daou_orphan_pins_3161 | cancel_error | text | YES | | NULL | |
...
| galaxia_barcode_log | order_delivery_id | int | NO | MUL | NULL | |
...
| giftiel_exchange_history | id | bigint | NO | PRI | NULL | auto_increment |
| giftiel_exchange_history | order_delivery_id | int | YES | MUL | NULL | |
| giftiel_exchange_history | matched_by | enum('TR_ID','COUPON_NUMBER','NONE') | NO | | NULL | |
| giftiel_exchange_history | tr_id | varchar(100) | NO | MUL | NULL | |
| giftiel_exchange_history | coupon_number | varchar(50) | NO | MUL | NULL | |
| giftiel_exchange_history | cmd_type | enum('L1','L2') | NO | | NULL | |
| giftiel_exchange_history | serv_code | varchar(4) | NO | | NULL | |
| giftiel_exchange_history | auth_code | varchar(20) | YES | | NULL | |
| giftiel_exchange_history | auth_date | datetime | NO | MUL | NULL | |
| giftiel_exchange_history | use_price | decimal(20,2) | YES | | NULL | |
| giftiel_exchange_history | bal_price | decimal(20,2) | YES | | NULL | |
| giftiel_exchange_history | coupon_type | varchar(2) | YES | | NULL | |
| giftiel_exchange_history | bi_code | varchar(20) | YES | | NULL | |
| giftiel_exchange_history | bi_name | varchar(50) | YES | | NULL | |
| giftiel_exchange_history | date_time | varchar(19) | YES | | NULL | |
| giftiel_exchange_history | result_code | varchar(4) | YES | | NULL | |
| giftiel_exchange_history | result_msg | varchar(500) | YES | | NULL | |
| giftiel_exchange_history | request_ip | varchar(45) | NO | | NULL | |
| giftiel_exchange_history | received_at | datetime | NO | | CURRENT_TIMESTAMP | DEFAULT_GENERATED |
| giftiel_exchange_history | created_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED |
| giftiel_exchange_history | updated_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED on update CURRENT_TIMESTAMP(6) |
| giftiel_exchange_history | deleted_at | datetime(6) | YES | | NULL | |
...
| notice | content | varchar(15000) | NO | | NULL | |
...
| order | code | varchar(256) | NO | UNI | NULL | |
...
| order | ssg_event_id | int | YES | MUL | NULL | |
...
| order_delivery | status | varchar(255) | NO | MUL | NULL | |
...
| order_delivery | personal_code | varchar(50) | YES | | NULL | |
| order_delivery | ssg_event_id | int | YES | | NULL | |
| order_delivery | coupon_status | varchar(255) | NO | | NOT_USED | |
...
| order_delivery | api_error_code | varchar(100) | YES | | NULL | |
| order_delivery | api_error_message | varchar(255) | YES | | NULL | |
...
| order_delivery_bk_3160_20260407 | created_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED |
| order_delivery_bk_3160_20260407 | updated_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED on update CURRENT_TIMESTAMP(6) |
| order_delivery_bk_3160_20260407 | deleted_at | datetime(6) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | id | int | NO | | 0 | |
| order_delivery_bk_3160_20260407 | status | varchar(255) | NO | | NULL | |
| order_delivery_bk_3160_20260407 | order_product_mapping_id | int | NO | | NULL | |
| order_delivery_bk_3160_20260407 | delivery_method | varchar(255) | NO | | NULL | |
| order_delivery_bk_3160_20260407 | delivery_target | varchar(128) | NO | | NULL | |
| order_delivery_bk_3160_20260407 | original_delivery_target | varchar(128) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | image_path | varchar(512) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | replace_character1 | varchar(200) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | replace_character2 | varchar(200) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | replace_character3 | varchar(200) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | send_request_at | datetime | NO | | NULL | |
| order_delivery_bk_3160_20260407 | expire_at | datetime | YES | | NULL | |
| order_delivery_bk_3160_20260407 | transaction_id | varchar(256) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | external_tr_id | varchar(26) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | bar_code | varchar(256) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | personal_code | varchar(50) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | ssg_event_id | int | YES | | NULL | |
| order_delivery_bk_3160_20260407 | coupon_status | varchar(255) | NO | | NOT_USED | |
| order_delivery_bk_3160_20260407 | email_coupon_status | varchar(100) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | ssg_transaction_id | varchar(200) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | choice_select_product_id | int | YES | | NULL | |
| order_delivery_bk_3160_20260407 | coupon_issued_at | datetime | YES | | NULL | |
| order_delivery_bk_3160_20260407 | coupon_num | varchar(100) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | trade_at | datetime | YES | | NULL | |
| order_delivery_bk_3160_20260407 | galaxia_balance | int | NO | | 0 | |
| order_delivery_bk_3160_20260407 | api_error_code | varchar(100) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | api_error_message | varchar(255) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | encourage_at | datetime | YES | | NULL | |
| order_delivery_bk_3160_20260407 | resend_at | datetime | YES | | NULL | |
| order_delivery_bk_3160_20260407 | replaced_from_id | bigint | YES | | NULL | |
| order_delivery_bk_3160_20260407 | failed_at | datetime | YES | | NULL | |
| order_delivery_bk_3160_20260407 | refund_status | enum('PROGRESS','APPROVE','COMPLETE') | YES | | NULL | |
| order_delivery_bk_3160_20260407 | refund_ratio | int | YES | | NULL | |
| order_delivery_bk_3160_20260407 | settle_fee | decimal(5,2) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | settle_price_adjustment | varchar(20) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | settle_discount_type | varchar(50) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | refund_register_at | datetime | YES | | NULL | |
| order_delivery_bk_3160_20260407 | bank_name | varchar(255) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | bank_account | varchar(255) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | bank_account_owner | varchar(255) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | refund_at | datetime | YES | | NULL | |
| order_delivery_bk_3160_20260407 | approve_at | datetime | YES | | NULL | |
| order_delivery_bk_3160_20260407 | actual_send_at | datetime | YES | | NULL | |
| order_delivery_bk_3160_20260407 | email_receiver_phone | varchar(512) | YES | | NULL | |
| order_delivery_bk_3160_20260407 | trade_place | varchar(200) | YES | | NULL | |
...
| order_from_definition | id | int | NO | PRI | NULL | auto_increment |
| order_from_definition | type | varchar(100) | NO | | NULL | |
| order_from_definition | user_id | int | NO | MUL | NULL | |
...
| order_from_definition | active_from_key | varchar(255) | YES | UNI | NULL | STORED GENERATED |
...
| order_like | id | int | NO | PRI | NULL | auto_increment |
| order_like | user_id | int | NO | | NULL | |
| order_like | order_id | int | NO | | NULL | |
| order_like | is_like | tinyint | NO | | NULL | |
...
| order_real_product | business_user_id | int | YES | | NULL | |
| order_real_product | event_name | varchar(100) | NO | | NULL | |
| order_real_product | finished_at | datetime | YES | | NULL | |
| order_real_product | status | enum('ORDER_PENDING','ORDER_CONFIRM','ORDER_COMPLETED','STORAGE_COMPLETED','DELIVERY_PROGRESS','DELIVERY_COMPLETED','ORDER_CANCELED','ORDER_EDIT_REQUEST') | NO | | NULL | |
...
| order_real_product_mapping | tracking_number | varchar(255) | NO | | NULL | |
...
| other_service_sale | created_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED |
| other_service_sale | updated_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED on update CURRENT_TIMESTAMP(6) |
| other_service_sale | deleted_at | datetime(6) | YES | | NULL | |
...
| other_service_sale | is_vat | tinyint | NO | | NULL | |
...
| other_service_sale_product | created_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED |
| other_service_sale_product | updated_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED on update CURRENT_TIMESTAMP(6) |
| other_service_sale_product | deleted_at | datetime(6) | YES | | NULL | |
...
| other_service_sale_product | price | int | NO | | NULL | |
| other_service_sale_product_mapping | created_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED |
| other_service_sale_product_mapping | updated_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED on update CURRENT_TIMESTAMP(6) |
| other_service_sale_product_mapping | deleted_at | datetime(6) | YES | | NULL | |
...
| other_service_sale_type | created_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED |
| other_service_sale_type | updated_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED on update CURRENT_TIMESTAMP(6) |
| other_service_sale_type | deleted_at | datetime(6) | YES | | NULL | |
...
| partner_company | type | enum('GIFT_SHOW','GIFTIEL','CULTURELAND','GALAXIA','SSG','DAOU') | YES | | NULL | |
...
| partner_company_extern_history | type | enum('GIFT_SHOW','GS_M_BIZ','GIFTIEL','CULTURELAND','GALAXIA','SSG') | NO | | NULL | |
...
| product_choice_mapping | id | int | NO | PRI | NULL | auto_increment |
| product_choice_mapping | choice_product_id | int | NO | | NULL | |
| product_choice_mapping | product_id | int | NO | | NULL | |
...
| product_like | id | int | NO | PRI | NULL | auto_increment |
| product_like | user_id | int | NO | | NULL | |
| product_like | product_id | int | NO | | NULL | |
| product_like | is_like | tinyint | NO | | NULL | |
| product_shared_list_file | id | int | NO | PRI | NULL | auto_increment |
| product_shared_list_file | user_id | int | NO | MUL | NULL | |
...
| qna | content | varchar(5000) | YES | | NULL | |
| qna | answer | varchar(500) | YES | | NULL | |
...
| shipping_storage | created_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED |
| shipping_storage | updated_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED on update CURRENT_TIMESTAMP(6) |
| shipping_storage | deleted_at | datetime(6) | YES | | NULL | |
| shipping_storage | id | int | NO | PRI | NULL | auto_increment |
| shipping_storage | code | varchar(255) | NO | | NULL | |
| shipping_storage | type | int | NO | | NULL | |
...
| ssg_event | no | varchar(20) | NO | | NULL | |
...
| ssg_event_amount_history | is_temporary | tinyint(1) | NO | | 1 | |
...
| user | person_category | varchar(100) | NO | | GENERAL | |
...
| user | is_head_person | tinyint(1) | YES | | 0 | |
...
| user | document_company_type | varchar(20) | YES | | ENMAD | |
...
| user_discount | created_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED |
| user_discount | updated_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED on update CURRENT_TIMESTAMP(6) |
| user_discount | deleted_at | datetime(6) | YES | | NULL | |
...
| user_sync_product_event | person_name | varchar(255) | NO | | NULL | |
| user_sync_product_event | name | varchar(255) | NO | | NULL | |
| user_sync_product_event | code | varchar(255) | NO | | NULL | |
| user_sync_product_event | phone | varchar(255) | NO | | NULL | |
| user_sync_product_event | email | varchar(255) | NO | | NULL | |
| user_sync_product_event | status | varchar(255) | NO | | NULL | |
| user_sync_product_event | admin_user_id | int | YES | MUL | NULL | |
| user_sync_product_event_mapping | created_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED |
| user_sync_product_event_mapping | updated_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED on update CURRENT_TIMESTAMP(6) |
| user_sync_product_event_mapping | deleted_at | datetime(6) | YES | | NULL | |
| user_sync_product_event_mapping | id | int | NO | PRI | NULL | auto_increment |
| user_sync_product_event_mapping | user_sync_product_event_id | int | NO | MUL | NULL | |
| user_sync_product_event_mapping | product_id | int | NO | MUL | NULL | |
| user_task_history | created_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED |
| user_task_history | updated_at | datetime(6) | NO | | CURRENT_TIMESTAMP(6) | DEFAULT_GENERATED on update CURRENT_TIMESTAMP(6) |
| user_task_history | deleted_at | datetime(6) | YES | | NULL | |
| user_task_history | id | int | NO | PRI | NULL | auto_increment |
| user_task_history | user_id | int | NO | | NULL | |
| user_task_history | content | text | YES | | NULL | |
| user_task_history | admin_user_id | int | NO | | NULL | |

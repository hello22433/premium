    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#ffffff; max-width:500px; margin:0; border:1px solid #ddd;">
      <tr>
        ...
        <td align="center" style="padding:0;">
          ...
          -->
          <img src="${obj.topImagePath}" width="480" height="157" alt="배너 이미지" style="display:block; border:none;" />
        </td>
      </tr>
      <tr>
        <!-- 2. 내용 -->
      ...
      <tr>
        ...
        <td style="padding:10px 20px;">
          <table style="width:100%; cellpadding=0; cellspacing=0; border=0;">
            <tr>
              <!-- 쿠폰 이미지 (왼쪽) -->
              <td style="width:240px; valign=top; style=padding-right:15px;">
                <img src="${obj.productImagePath}" width="240" height="240" alt="상품 이미지" style="border-radius:8px; display:block;" />
              </td>
              <!-- 사용방법 (오른쪽) -->
              <td style="valign=top; font-size:15px; line-height:1.6; color:#555;">

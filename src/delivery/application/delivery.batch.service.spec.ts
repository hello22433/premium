    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: DeliveryTrackHttp, useValue: {} },
        {
          ...
          useValue: { decryptDeliveryTarget: jest.fn(), encryptDeliveryTarget: jest.fn(), encryptJson: jest.fn() },
        },
        ...
        {
          provide: DeliverySendService,
          useValue: {
            markSendSuccess: jest.fn(),
            markSendFail: jest.fn(),
            buildSmsText: jest.fn(),
            sendSms: jest.fn(),
        ...
        {
          provide: RefundLedgerService,
          useValue: {
            exists: jest.fn(),
            claim: jest.fn(),
            release: jest.fn(),
            isSsgSettled: jest.fn(),
            markSsgSettled: jest.fn(),
            getLedgerId: jest.fn(),
          },
        },

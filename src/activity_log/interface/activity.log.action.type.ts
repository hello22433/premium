export enum ActivityLogActionType {
  ...
  PARTNER_SETTLE_VARIANCE_APPROVE = 'PARTNER_SETTLE_VARIANCE_APPROVE', // 협력사 지급 차이 승인 (조정 원장 생성)
  PARTNER_SETTLE_VARIANCE_REJECT = 'PARTNER_SETTLE_VARIANCE_REJECT', // 협력사 지급 차이 반려
}
